      ...
      <div>
        ...
        <section className="bg-[#D1CAA1] py-16 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto mt-5">
            We ensure timely delivery of high-quality engine oils, prioritizing
            ...
            {[
              {
                ...
                desc: "A seamless distribution experience tailored for you.",
              },
              {
                img: Horse,
                title: "Commitment to Quality",
                desc: "Every delivery meets high standards.",
              },
              {
                img: Startup,
                title: "Get Started Today",
                desc: "Join us for reliable engine oil solutions.",
              },
              ...
              <div key={index} className="text-center max-w-xs">
                <img
                  src={img}
                  alt={title}
                  className="w-72 h-48 mx-auto object-cover rounded-xl"
                />
            ...
            {[
              {
                ...
                desc: "Ensuring availability nationwide",
              },
              {
                img: Support,
                title: "Dedicated Support",
                desc: "Exceptional customer service to meet your needs",
              },
              {
                img: Innovate,
                title: "Innovative Solutions",
                desc: "Advanced formulations for optimal engine performance",
              },
            ].map(({ img, title, desc }, index) => (
              <div key={index} className="max-w-xs text-center">
                ...
                >
                  <button className="block text-2xl font-light underline mt-2 pl-20">
                    Learn more
                  </button>
                </Link>
              </div>
        ...
        <section className="bg-[#FC7A1E] py-12 md:py-16 text-white flex flex-col lg:flex-row items-center justify-between px-6 md:px-12">
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight">
              Discover Our Impressive
            </h2>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight mt-3">
              Achievements in Engine Oil
            </h2>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight mt-3 pb-6">
              Distribution
            </h2>

            <p className="text-base md:text-lg max-w-md">
              With over 20 years in the industry, we have established ourselves
              as a trusted leader in engine oil distribution.
            </p>
            <p className="text-base md:text-lg mt-4 max-w-md">
              Our commitment to quality and customer satisfaction has resulted
              in thousands of satisfied clients.
            </p>

            <div className="flex flex-col sm:flex-row gap-10 mt-8">
              <div>
                <h3 className="text-5xl md:text-6xl font-bold">1M+</h3>
                <p className="text-lg md:text-xl mt-2">
                  Gallons of Oil distributed annually.
                </p>
              </div>
              <div>
                <h3 className="text-5xl md:text-6xl font-bold">95%</h3>
                <p className="text-lg md:text-xl mt-2">
